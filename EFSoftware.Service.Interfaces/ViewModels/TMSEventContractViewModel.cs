...
{
    public class TMSEventContractViewModel
    {
        public TMSEventContractViewModel( int id, int employeeId, string eventType, DateTime periodStart, DateTime periodEnd, int zoneLocationId,
            int zoneId,
            ...
            int mealAllowanceId,
            string mealAllowanceValue, int monthlyShiftAllowanceId, string monthlyShiftAllowanceValue, bool eligibilityOt, int maxWorkingHours,
            int otPhId, string otPhValue, int otRdId, string otRdValue, int otOId, string otOValue, int otStdId, string otStdValue,
            int transportAllowanceId, string transportAllowanceValue,
    ...
    public class TMSEventContractCreateViewModel
    {
        public int EmployeeId { get; set; }
