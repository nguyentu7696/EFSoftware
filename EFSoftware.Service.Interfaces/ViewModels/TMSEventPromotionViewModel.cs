...
{
    public class TMSEventPromotionViewModel
    {
        public TMSEventPromotionViewModel(int id, int employeeId, string eventType, DateTime effectiveDate, string designation,
            string designationType, string employeeType, int zoneLocationId, int shiftId, string shiftKey, string subContractor,
           string recall, string remarks, bool eligibilityShift, bool eligibilityAllowance, int mealAllowanceId, string mealAllowanceValue,
        int monthlyShiftAllowanceId, string monthlyShiftAllowanceValue, bool eligibilityOt, int maxWorkingHours, int otPhId, string otPhValue,
         int otRdId, string otRdValue, int otOId, string otOValue, int otStdId , string otStdValue, int transportAllowanceId,
         string transportAllowanceValue, int status,
            string zoneLocationName, int jobsiteId, string jobsiteName, int siteId, string siteName, int departmentId, string departmentName)
        {
            ...
            OtPhId = otPhId; OtPhValue = otPhValue; OtRdId = otRdId; OtRdValue = otRdValue; OtOId = otOId; OtOValue = otOValue;
            OtStdId = otStdId; OtStdValue = otStdValue; TransportAllowanceId = transportAllowanceId; TransportAllowanceValue = transportAllowanceValue;
            Status = status; ZoneLocationName = zoneLocationName; JobSiteId = jobsiteId; JobSiteName = jobsiteName;
            SiteId = siteId; SiteName = siteName; DepartmentId = departmentId; DepartmentName = departmentName;
        }
    ...
    public class TMSEventPromotionCreateViewModel
    {
        public int EmployeeId { get; set; }
        ...
        [Required(ErrorMessage = "ShiftKey is required")]
        public string ShiftKey { get; set; }
