...
export class JobsiteService {
  ...
  getCount(companyid, departmentid, siteid, filterByName) {
    return this._Request.Request('api/TMSJobSite/GetAllListJobSite?companyid=' + companyid +
  ...
  getJobSiteList(page, size, companyid, departmentid, siteid, filterByName) {
    return this._Request.Request('api/TMSJobSite/GetAllPagingListJobSite?page=' + page + '&pageSize=' + size
