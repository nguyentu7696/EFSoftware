...
{
    public class TMSEventContractController : BaseController
    {
        #region Constructor

        private ITMSEventContractService _tmsEventContractService;

        public TMSEventContractController(ITMSEventContractService tmsEventContractService)
        {
            _tmsEventContractService = tmsEventContractService;
        }
        ...
        public IActionResult GetByEmployeeId(int employeeId)
        {
            ...
            else
            {
                try
                {
                    var data = _tmsEventContractService.GetByEmployeeId(employeeId);
        ...
        [HttpPost]
        [Route("Add")]
        public IActionResult Add([FromBody]TMSEventContractCreateViewModel Vm)
        {
            ...
            else
            {
                try
                {
                    var data = _tmsEventContractService.Add(Vm);
                    return new OkObjectResult(new GenericResult(true, data));
                }
                catch (Exception ex)
                {
