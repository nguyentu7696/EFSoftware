...
{
    public class TMSAttendanceController : BaseController
    {
        #region Constructor

        private ITMSAttendanceService _tmsAttendanceService;

        public TMSAttendanceController(ITMSAttendanceService tmsAttendanceService)
        {
            _tmsAttendanceService = tmsAttendanceService;
        }
        ...
        public IActionResult GetAll()
        {
            try
            {
                var data = _tmsAttendanceService.GetAll();
        ...
        public IActionResult GetAllPaging(int page, int pageSize)
        {
            try
            {
                var data = _tmsAttendanceService.GetAllPaging(page, pageSize);
                return new OkObjectResult(new GenericResult(true, data));
            }
            catch (Exception ex)
            {
        ...
        public IActionResult GetAllPagingWithCompany(int page, int pageSize, int companyid, string filterByName)
        {
            try
            {
                var data = _tmsAttendanceService.GetAllPagingWithCompany(page, pageSize, companyid, filterByName);
                return new OkObjectResult(new GenericResult(true, data));
            }
            catch (Exception ex)
            {
        ...
        public IActionResult GetAllWithCompany(int companyid, string filterByName)
        {
            try
            {
                var data = _tmsAttendanceService.GetAllWithCompany(companyid, filterByName);
                return new OkObjectResult(new GenericResult(true, data));
            }
            catch (Exception ex)
            {
        ...
        public IActionResult GetById(int id)
        {
            ...
            else
            {
                try
                {
                    var data = _tmsAttendanceService.GetById(id);
                    return new OkObjectResult(new GenericResult(true, data));
                }
                catch (Exception ex)
                {
        ...
        [HttpPost]
        [Route("Add")]
        public IActionResult Add([FromBody]TMSAttendanceCreateViewModel Vm)
        {
            if (!ModelState.IsValid)
            {
                var allErrors = ModelState.Values.SelectMany(v => v.Errors);
        ...
        [HttpPut]
        [Route("Update")]
        public IActionResult Update([FromBody]TMSAttendanceViewModel Vm)
        {
            if (!ModelState.IsValid)
            {
                var allErrors = ModelState.Values.SelectMany(v => v.Errors);
            ...
            else
            {
                try
                {
                    ...
                    _tmsAttendanceService.Update(Vm);
        ...
        public IActionResult Delete(int id)
        {
            ...
            else
            {
                try
                {
                    _tmsAttendanceService.Delete(id);
