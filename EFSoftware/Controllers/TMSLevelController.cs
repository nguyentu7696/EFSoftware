...
{
    public class TMSLevelController : BaseController
    {
        #region Constructor

        private ITMSLevelService _tmsLevelService;

        public TMSLevelController(ITMSLevelService tmsLevelService)
        {
            _tmsLevelService = tmsLevelService;
        }
        ...
        public IActionResult GetAll()
        {
            try
            {
                var data = _tmsLevelService.GetAll();
        ...
        public IActionResult GetAllPaging(int page, int pageSize)
        {
            try
            {
                var data = _tmsLevelService.GetAllPaging(page, pageSize);
                return new OkObjectResult(new GenericResult(true, data));
            }
            catch (Exception ex)
            {
        ...
        public IActionResult GetAllPagingWithZoneLocation(int page, int pageSize, int zonelocationid , string filterByName = "")
        {
            try
            {
                var data = _tmsLevelService.GetAllPagingWithZoneLocation(page, pageSize, zonelocationid, filterByName);
                return new OkObjectResult(new GenericResult(true, data));
            }
            catch (Exception ex)
            {
        ...
        public IActionResult GetAllWithZoneLocation(int zonelocationid, string filterByName = "")
        {
            try
            {
                var data = _tmsLevelService.GetAllWithZoneLocation(zonelocationid,filterByName);
                return new OkObjectResult(new GenericResult(true, data));
            }
            catch (Exception ex)
            {
        ...
        public IActionResult GetById(int id)
        {
            ...
            else
            {
                try
                {
                    var data = _tmsLevelService.GetById(id);
                    return new OkObjectResult(new GenericResult(true, data));
                }
                catch (Exception ex)
                {
        ...
        [HttpPost]
        [Route("Add")]
        public IActionResult Add([FromBody]TMSLevelCreateViewModel Vm)
        {
        ...
        [HttpPut]
        [Route("Update")]
        public IActionResult Update([FromBody]TMSLevelViewModel Vm)
        {
            if (!ModelState.IsValid)
            {
                var allErrors = ModelState.Values.SelectMany(v => v.Errors);
